...
a.css({width: width - 15, "vertical-align": "top", "overflow":"hidden","float":"left"});
};
...
'.jstree-grid-header-regular {font-size:12px}',
...
last = last.css(conf).css({width: width - 2,"padding-left":paddingleft+"px"}).addClass("jstree-grid-cell jstree-grid-cell-"+classAdd+" "+wcl+ " " + wideValClass + (tr?" ui-state-default":"")).addClass("jstree-grid-col-"+i);
